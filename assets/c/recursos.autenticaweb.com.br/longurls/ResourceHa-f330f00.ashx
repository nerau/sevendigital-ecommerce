...
.line .title+span, .lineHistBusca:after, .tagsTitle:after, .txtLoja .line:after, .divOpinioes:after, .title-fechamento .titleFechamento+span, .title-escolha-frete h3.titleFrete+span, .divTitleLogin:after {
    border-bottom: 1px solid #142B4B;
    display: table-cell;
    height: 1px;
    top: 9px;
    position: absolute;
...
.ico-menu-fecha {
    ...
    border-bottom: 2px solid #142B4B;
}
.menu-mobile-dynamic {
    width: 85%;
    height: 100%;
...
.submenu-carrinho {
    border-top-color: #142B4B !important;
}

.submenu-carrinho:before {
    border-bottom-color: #142B4B !important;
}
