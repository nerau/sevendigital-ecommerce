...
.ac_results {border: 1px solid #ddd;background: #fff;box-shadow: 0 0 3px 3px rgba(0, 0, 0, 0.1);padding-bottom:5px;border-radius: 0 0 5px 5px;margin: -8px 0 0 24px;display: block !important;}
